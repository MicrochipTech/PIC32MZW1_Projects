...
This example can be used to measure SNTP time.
...
Once connected, the time taken to fetch time by SNTP will be printed in the console.
...
9. Time taken by SNTP client to fetch time will be printed in the console.